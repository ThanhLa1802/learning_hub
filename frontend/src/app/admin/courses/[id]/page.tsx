...
export default function EditCoursePage() {
    ...
    const set = (k: keyof AdminCourse, v: unknown) => setForm((f) => f ? { ...f, [k]: v } : f)
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        setSaving(true)
        try {
            await adminApi.updateCourse(id, form)
    ...
    return (
        <div className="max-w-xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                <Field label="Domain">
                    <input className="input bg-muted cursor-not-allowed" value={form.domain_name} disabled />
                </Field>
                <Field label="Slug">
